...
public class GlobalExceptionHandler {
    ...
    public Map<String, String> handleUserDuplicateException(DuplicateCourseCodeException duplicateCourseCodeException) {

        Map<String, String> mensaje = new HashMap<>();
        mensaje.put("mensaje", "Recurso no registrado: " + duplicateCourseCodeException.getMessage());
    ...
    @ResponseStatus(HttpStatus.CONFLICT)
    public Map<String, String> handleUserFeignException(FeignException feignException) {

        Map<String, String> mensaje = new HashMap<>();
        mensaje.put("mensaje", "Recurso no registrado: " + feignException.getMessage());
